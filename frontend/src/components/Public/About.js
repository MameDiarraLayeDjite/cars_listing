  ...
  const testimonials = [
    {
      ...
      text: "Excellente expérience ! L'équipe a été très professionnelle et m'a aidé à trouver la voiture parfaite. Je recommande vivement SarayaAutoSales.",
      rating: 5,
    },
    {
      name: "Thomas Bernard",
      ...
      <Container maxWidth="lg">
        ...
        <Grid container spacing={6} sx={{ mb: 10 }}>
          <Grid item xs={12} md={6}>
            ...
            >
              Fondée en 2010, SarayaAutoSales est née d'une passion pour
              l'automobile et d'une volonté de transformer l'expérience d'achat
            ...
            >
              Nous avons commencé avec un petit parc de 10 voitures et une
              mission simple : offrir de la qualité et de la transparence.
              Aujourd'hui, nous sommes fiers d'être l'un des leaders du marché
              avec un inventaire diversifié et une clientèle fidèle.
            </Typography>
            <Typography
              variant="body1"
              sx={{
            ...
            >
              Chaque véhicule que nous proposons est rigoureusement inspecté
